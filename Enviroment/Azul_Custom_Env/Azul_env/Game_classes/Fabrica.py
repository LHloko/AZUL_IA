...
{self.factory_floor}\n"""
    ...
    demais no chao de fabrica, caso a fabrica esteja vazia retorna True
    '''
    def pick_ceramic_board(self, factury):
        #Solicita a peça
        piece = int(input("Escolha uma ceramica: "))
        ...
        while not self.not_ceramic(fac, piece):
            piece = int(input("Ceramica nao encontrada, escolha outra: "))
    ...
    def pick_ceramic_floor(self, piece):
        ...
        #Impede de se pegar o -1
        while not piece != -1 :
            piece = int(input("Ceramica nao encontrada, escolha outra: "))


        #Verifica se tem esse tipo de ceramica no chao
        while not self.not_ceramic(floor, piece):
            piece = int(input("Ceramica nao encontrada, escolha outra: "))
